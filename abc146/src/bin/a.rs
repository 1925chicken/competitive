...
fn solve(read: &mut snio::Reader<std::io::StdinLock<'_>>) {
	...
	if 	"SUN".to_string() == s{ println!("7");}
	else if	"MON".to_string() == s {println!("6");}
	else if	"TUE".to_string() == s {println!("5");}
	else if	"WED".to_string() == s {println!("4");}
	else if	"THU".to_string() == s {println!("3");}
	else if	"FRI".to_string() == s {println!("2");}
		else {println!("1")}
